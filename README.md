[![Build Status](https://dev.azure.com/benhalstd/PhDCode/_apis/build/status/BenHals.PhDCode?branchName=master)](https://dev.azure.com/benhalstd/PhDCode/_build/latest?definitionId=1&branchName=master)
# FiCSUM
