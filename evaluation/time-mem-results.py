...
#%%
signoise_data_dir = pathlib.Path(r"S:\PhD\Packages\PhDCode\output\sig-noise-6")
fweight_data_dir = pathlib.Path(r"S:\PhD\Packages\PhDCode\output\feature-weight-test-opt")
fweight_nonopt_data_dir = pathlib.Path(r"S:\PhD\Packages\PhDCode\output\feature-weight-test-nonopt")
fweight_nonopt_data_dir2 = pathlib.Path(r"S:\PhD\Packages\PhDCode\output\feature-weight-test-nonopt-2")
