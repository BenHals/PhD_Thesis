...
#%%
#Goal is to find a case in AQTemp where FICSUM and PhDCode perform significantly differently.
...
for seed in [5]:
    ...
    ax.legend(handles, map({"CC": "PhDCode", "ficsum": "FICSUM"}.get, labels))
...
for seed in [5]:
    ...
    plt.show()
#%%
classifier_map = {"CC": "PhDCode", "ficsum": "FICSUM"}
...
for fp in found_paths:
    print(fp[1]['classifier'])
    print(fp[1]['overall_time'])