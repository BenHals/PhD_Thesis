...
if __name__ == "__main__":
    ...
    my_parser.add_argument('--framework', default='rcd', nargs="*", type=str)
    ...
    moa_path = (pathlib.Path(args.moalocation)).resolve()
    ...
    if given_options:
        ...
        for framework in (args.framework if type(args.framework) is list else [args.framework]):
