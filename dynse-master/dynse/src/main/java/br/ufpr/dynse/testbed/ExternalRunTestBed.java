...
import br.ufpr.dynse.evaluation.EvaluateInterleavedChunksUFPRExternal;
import br.ufpr.dynse.util.UFPRLearningCurveUtils;
import moa.streams.ArffFileStream;
import moa.tasks.StandardTaskMonitor;
import moa.tasks.TaskMonitor;

public class ExternalRunTestBed implements MultipleExecutionsTestbed{
	// Not used
	private static final String PATH_DATASET = "TEST.arff";
	...
	public void executeTestsKE(int numberExecutions, String inputFilePath, String outputFileName) throws Exception{
		...
		for(int i =0;i < numberExecutions; i++){
			...
			EvaluateInterleavedChunksUFPRExternal evaluator = new EvaluateInterleavedChunksUFPRExternal();
