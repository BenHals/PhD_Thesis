...
from PhDCode.Classifier.feature_selection.mutual_information import bin_X, MI_histogram_estimation_cache_mat, MI_estimation_cache_mat
from PhDCode.Classifier.select_classifier import SELeCTClassifier, get_dimension_weights
...
#                                     102,
#                                     raw_data_path = pathlib.Path(r'S:\PhD\Packages\PhDCode\RawData') / 'Synthetic')
concepts = load_synthetic_concepts('FeatureWeightExpGenerator',
                                    20,
                                    raw_data_path = pathlib.Path(r'S:\PhD\Packages\PhDCode\RawData') / 'Synthetic')
...
df
# %%
sns.scatterplot(data=df, x='index', y='f0')
# %%
