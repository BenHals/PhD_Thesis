...
import matplotlib.pyplot as plt
sns.set()
log_path = pathlib.Path(r'H:\output\expDefault\PhDCode-master-2dfb6aa\Arabic\1001\run_1229201974012767153_0.csv')
log_path_2 = pathlib.Path(r'H:\output\expDefault\PhDCode-master-2dfb6aa\Arabic\1001\run_3369313819230199491_0.csv')
log_path_2003_fisher = pathlib.Path(r'H:\output\expDefault\PhDCode-master-2dfb6aa\Arabic\2003\run_9188542613100145381_0.csv')
log_path_2003_MIM = pathlib.Path(r'H:\output\expDefault\PhDCode-master-2dfb6aa\Arabic\2003\run_-7177387291253706998_0.csv')
