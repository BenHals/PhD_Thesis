...
from PhDCode.Exploration.random_tree_generator_sample import Sampler
...
class HyperplaneSampleGenerator(Stream):
    ...
    def generate_sampler(self):
        ...
        """
        self.sampler = Sampler(self.n_num_features, self.sampler_random_state, features = self.sampler_features)
