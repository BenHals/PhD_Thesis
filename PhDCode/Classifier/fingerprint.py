...
from PhDCode.Classifier.matrixSketch import FrequentDirections
...
class FingerprintSketchCache(FingerprintCache):
    ...
    def reset_sketch_feature(self, source, feature, value):
        ...
        # if np.isnan(reset_col).any():
        #     print("nan in reset")
        #     reset_col = np.nan_to_num(reset_col)
        self.sketch._sketch[:self.num_bins, flat_ignore_index] = reset_col
        # if np.isnan(self.sketch._sketch).any():
        #     print("nan append in reset col")
        #     print(reset_col)
        #     exit()
