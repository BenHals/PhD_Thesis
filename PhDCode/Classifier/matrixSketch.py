...
class FrequentDirections(MatrixSketcherBase):
    ...
    def append(self, vector):
        ...
        #     print("nan append vector")
        #     vector = zeros(vector.shape)
        self._sketch[self.nextZeroRow, :] = vector
        self.nextZeroRow += 1
        # if np.isnan(self._sketch).any():
        #     print("nan append in sketch")
        #     exit()
    ...
    def __rotate__(self):
        ...
        # if np.isnan(self._sketch).any():
        #     print("nan rotate in sketch")
        #     self._sketch = np.nan_to_num(self._sketch)
        #     # for r,i  in self._sketch:
        #     #     print(r)
        #     # exit()
    ...
    def make_reset_column(self, value):
        ...
        # if np.isnan(scaled[:self.ell]).any():
        #     print(scaled)
        #     print(s)
        #     print(Vt)
        #     print(raw_column)
        #     print(self.row_multipliers)
        return scaled[:self.ell]
