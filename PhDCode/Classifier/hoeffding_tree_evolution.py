...
def HoeffdingTreeEvo(max_byte_size=33554432, memory_estimate_period=1000000, grace_period=200, split_criterion='info_gain',
    ...
    return HoeffdingTreeEvo(max_byte_size=max_byte_size,
...
class HoeffdingTreeEvoClassifier(BaseSKMObject, ClassifierMixin):
