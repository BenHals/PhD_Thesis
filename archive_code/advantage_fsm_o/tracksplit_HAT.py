...
from .tracksplit_hoeffding_tree import TS_HoeffdingTree
...
class TS_HAT(TS_HoeffdingTree):
    ...
    def __init__(self,
        ...
        super(TS_HAT, self).__init__(max_byte_size=max_byte_size,
