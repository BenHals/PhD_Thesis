...
class TS_HoeffdingTree(BaseSKMObject, ClassifierMixin):
    ...
    class Node(metaclass=ABCMeta):
        ...
        def filter_instance_to_leaf(self, X, parent, parent_branch):
            ...
            """
            return TS_HoeffdingTree.FoundNode(self, parent, parent_branch)
        ...
        def filter_instance_to_leaf(self, X, parent, parent_branch):
            ...
            if child_index >= 0:
                ...
                if child is not None:
                    ...
                    return TS_HoeffdingTree.FoundNode(None, self, child_index)
            else:
                return TS_HoeffdingTree.FoundNode(self, parent, parent_branch)
    ...
    def __init__(self,
        ...
        """ TS_HoeffdingTree class constructor."""
        super().__init__()
    ...
    def get_votes_for_instance(self, X):
        ...
        if self._tree_root is not None:
            ...
            return leaf_node.get_class_votes(X, self).copy()
        else:
            return {}
    ...
    def predict_proba(self, X):
        ...
        for i in range(r):
            ...
            # if any([math.isnan(x) for x in votes.values()]):
            #     print(votes)
            #     print("error")
            if votes == {}:
                ...
                if sum(votes.values()) != 0:
                    normalize_values_in_dict(votes, inplace=False)
        ...
        if not node.observed_class_distribution_is_pure():
            ...
            if should_split:
                ...
                if split_decision.split_test is None:
                    ...
                    self.splits_since_reset += split_decision.num_splits()
                    if parent is None:
