...
//    			System.out.println("Using model " + currentClassifier);
    	...
    	if(currentClassifier == null){
    		createModel();
			this.currentClassifierID = currentModels.size() + 1;
	...
	protected Measurement[] getModelMeasurementsImpl() {
		...
		measurementList.add(new Measurement("active_model", this.currentClassifier));
