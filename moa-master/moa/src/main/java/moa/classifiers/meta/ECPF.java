...
public class ECPF extends AbstractCPF implements MultiClassClassifier, CapabilitiesHandler {
	...
	boolean monitorchangeDetected = false;
	boolean monitorwarningDetected = false;
	int currentClassifierId = 0;
	...
	public void resetLearningImpl() {
		...
		this.monitorchangeDetected = false;
		this.monitorwarningDetected = false;
    ...
    private void getNextModel(){
		...
		this.currentClassifierId = bestModelIndex;
	...
	protected Measurement[] getModelMeasurementsImpl() {
		...
		measurementList.add(new Measurement("Change detected", this.monitorchangeDetected ? 1.0 : 0.0));
		measurementList.add(new Measurement("Warning detected", this.monitorwarningDetected ? 1.0 : 0.0));
		measurementList.add(new Measurement("active_model", this.currentClassifierId));
